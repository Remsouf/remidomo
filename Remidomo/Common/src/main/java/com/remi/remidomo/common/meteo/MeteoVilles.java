package com.remi.remidomo.common.meteo;
...
public class MeteoVilles extends Meteo {
	...
	public void updateData(BaseService service) {
		...
		service.addLog("Mise à jour des données météo (" + NB_DAYS + " jours)", BaseService.LogLevel.UPDATE);
	...
	public class XmlPullFeedParser {
	    ...
	    protected XmlPullFeedParser(BaseService service, String feedUrl){
	        try {
	    ...
	    protected InputStream getInputStream() {
	        try {
	        	...
	        	service.addLog("Impossible d'obtenir les infos météo", BaseService.LogLevel.HIGH);
	        	return null;
	        }
	    }
