...
public class PrefsNotif extends PreferenceFragment implements OnSharedPreferenceChangeListener {
    ...
    public void onCreate(Bundle savedInstanceState) {        
        ...
        sound_garage.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference pref) {
            	String actualUri = prefs.getString("sound_garage", DEFAULT_SOUND_GARAGE);
        ...
        sound_alert.setOnPreferenceClickListener(new Preference.OnPreferenceClickListener() {
            @Override
            public boolean onPreferenceClick(Preference pref) {
            	String actualUri = prefs.getString("sound_alert", DEFAULT_SOUND_ALERT);
            	Intent intent = new Intent(RingtoneManager.ACTION_RINGTONE_PICKER);
            	intent.putExtra(RingtoneManager.EXTRA_RINGTONE_TYPE, RingtoneManager.TYPE_NOTIFICATION);
        ...
        DEFAULT_SOUND_GARAGE = "android.resource://" + getActivity().getPackageName() + "/" + R.raw.garage_ok;
        DEFAULT_SOUND_ALERT = "android.resource://" + getActivity().getPackageName() + "/" + R.raw.garage_alert;
    }
    ...
    private void updateTexts() {
    	String value = prefs.getString("sound_garage", DEFAULT_SOUND_GARAGE);
    	if (DEFAULT_SOUND_GARAGE.equals(value)) {
    	...
    	value = prefs.getString("sound_alert", DEFAULT_SOUND_ALERT);
    	if (DEFAULT_SOUND_ALERT.equals(value)) {
        ...
        if (resultCode == Activity.RESULT_OK) {
             ...
             if (requestCode == Notifications.NotifType.GARAGE.ordinal()) {
            	 ...
            	 if (uri != null) {
            		 ...
            		 editor.putString("sound_alert", DEFAULT_SOUND_ALERT);
            	 }
             }
             editor.commit();
         }
